...
namespace DespesaViagem.Server.Controllers
{
    ...
    public class DespesaAlimentacaoController : ControllerBase
    {
        ...
        public async Task<ActionResult> ObterTodasDespesas()
        {
            ...
            Result<IEnumerable<DespesaAlimentacao>> result = await _despesasService.ObterTodasDespesas(int.Parse(idUsuario));
            ...
            return Ok(new ServiceResponse<IEnumerable<DespesaAlimentacaoDTO>> { Conteudo = despesas });
        }

        [HttpGet("viagem/{id:int}")]
        public async Task<ActionResult> ObterTodasDespesasViagem(int idViagem)
        {
            Result<IEnumerable<DespesaAlimentacao>> result = await _despesasService.ObterTodasDespesasViagem(idViagem);
